 ...
 * @license     http://opensource.org/licenses/OSL-3.0 The Open Software License 3.0
 */
namespace Webinse\FAQ4\Model\ResourceModel;
...
class Question extends AbstractDb
{
    ...
    protected function _construct()
    {
         ...
         *        set main entity table name "webinse_faq4_question" and primary key field name
         */
        $this->_init('webinse_blog4_posts', QuestionInterface::QUESTION_ID);
    }
